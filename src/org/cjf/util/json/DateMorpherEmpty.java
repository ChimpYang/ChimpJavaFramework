...
public class DateMorpherEmpty extends AbstractObjectMorpher {
	private Date defaultValue;
	private String[] formats;
	private boolean lenient;
	private Locale locale;

	public DateMorpherEmpty(String[] formats) {
		this(formats, Locale.getDefault(), false);
	}

	public DateMorpherEmpty(String[] formats, boolean lenient) {
		this(formats, Locale.getDefault(), lenient);
	}

	public DateMorpherEmpty(String[] formats, Date defaultValue) {
		this(formats, defaultValue, Locale.getDefault(), false);
	}

	public DateMorpherEmpty(String[] formats, Date defaultValue, Locale locale,
			boolean lenient) {
		super(true);
	...
	public DateMorpherEmpty(String[] formats, Locale locale) {
		this(formats, locale, false);
	}

	public DateMorpherEmpty(String[] formats, Locale locale, boolean lenient) {
		if ((formats == null) || (formats.length == 0)) {
			throw new MorphException("invalid array of formats");
		}
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof DateMorpherEmpty)) {
			return false;
		}

		DateMorpherEmpty other = (DateMorpherEmpty) obj;
