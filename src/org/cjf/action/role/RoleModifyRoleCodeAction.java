...
public class RoleModifyRoleCodeAction extends AbstractWebAction<Role> {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(RoleModifyRoleCodeAction.class);
	
	public RoleModifyRoleCodeAction() {
	...
	protected boolean process(Object obj) {
		...
		int count = biz.modifyCustom(item, "updateRoleCode");
		if(count != 1) {
			message = "修改失败，修改个数为0.";
