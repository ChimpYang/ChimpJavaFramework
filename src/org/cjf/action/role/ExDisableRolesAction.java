...
public class ExDisableRolesAction extends AbstractWebAction<Role> {

	private static final long serialVersionUID = -3615378791985076924L;
	private static final Logger logger = Logger.getLogger(ExDisableRolesAction.class);
	
	public ExDisableRolesAction() {
