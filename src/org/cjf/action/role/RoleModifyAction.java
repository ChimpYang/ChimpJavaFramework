...
public class RoleModifyAction extends AbstractWebAction<Role> {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(RoleModifyAction.class);
	...
	protected boolean checkParam(Object obj) {
		...
		if(count > 0) {
			message = "modify Role, but Role " + item.getRoleCode() + "already exists.";
			return false;
		}
