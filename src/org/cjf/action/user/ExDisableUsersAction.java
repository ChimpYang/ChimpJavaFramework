...
public class ExDisableUsersAction extends AbstractWebAction<User> {

	private static final long serialVersionUID = -3615378791985076924L;
	private static final Logger logger = Logger.getLogger(ExDisableUsersAction.class);
	
	public ExDisableUsersAction() {
	...
	protected Object getParamObject() {
		...
		for(Object obj: ids) {
			...
			item = new User();
			item.setId(id);
			item.setCurrentStatus(AppConst.STATUS_DISABLE);
