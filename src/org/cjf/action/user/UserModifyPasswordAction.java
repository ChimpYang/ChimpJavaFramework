...
public class UserModifyPasswordAction extends AbstractWebAction<User> {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(UserModifyPasswordAction.class);
	
	public UserModifyPasswordAction() {
