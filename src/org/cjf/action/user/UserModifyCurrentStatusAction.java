...
public class UserModifyCurrentStatusAction extends AbstractWebAction<User> {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(UserModifyCurrentStatusAction.class);
	
	public UserModifyCurrentStatusAction() {
