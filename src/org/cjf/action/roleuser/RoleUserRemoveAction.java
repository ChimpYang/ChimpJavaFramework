...
public class RoleUserRemoveAction extends AbstractWebAction<RoleUser> {

	private static final long serialVersionUID = -2966887228986459214L;
	private static final Logger logger = Logger.getLogger(RoleUserRemoveAction.class); 
	
	public RoleUserRemoveAction() {
	...
	protected boolean process(Object obj) {
		...
		boolean flag = biz.batchRemove(list, new RoleUser());
