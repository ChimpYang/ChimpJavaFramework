...
public class RoleUserGetListNotInRoleAction extends AbstractWebAction<RoleUser> {
	private static final long serialVersionUID = -2435438153486065834L;
	private static final Logger logger = Logger.getLogger(RoleUserGetListNotInRoleAction.class);
	
	public RoleUserGetListNotInRoleAction() {
	...
	protected boolean process(Object obj) {
		...
		int count = biz.getCountCustom(item, "countListUserNotInRole");
		List<RoleUser> list = biz.getListCustom(item, "listUserNotInRole", start, limit);
